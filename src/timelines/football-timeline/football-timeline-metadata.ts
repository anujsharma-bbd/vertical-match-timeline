import { GameEndComponent } from "src/gen2-components/timeline/common-incidents/game-end/game-end.component";
import { KickOffComponent } from "src/gen2-components/timeline/common-incidents/kick-off/kick-off.component";
